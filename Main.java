...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Average screen ratio: " + Response.average_screen_ratio().x + "x" + Response.average_screen_ratio().y); // for every 1 unit, you move x pixels on the screen
        System.out.println("Average aspect ratio: " + Response.average_aspect_ratio().x + ":" + Response.average_aspect_ratio().y);
